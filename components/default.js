...
var component, dom, emblem, extend, form2js, gift, hub, inject, ql, ref, rsvp, widget;
  ...
  render: function(state, params) {
    ...
    return dom('div', {
      ...
      emblem(), dom('h1', state.invite.to), dom('p', {
        ...
        dom('h2', 'Accomodation'), dom('p', [
          'There are several places to stay in and around Raglan. We recommend the ', dom('a', {
            attributes: {
              href: 'http://www.raglansunsetmotel.co.nz/'
            }
          }, 'Raglan Sunset Motel'), '.'
        ]), dom('p', 'Raglan Sunset Motel features 24 units offering a range of accommodation, studio units, Family Studios for up to 5 people an Executive unit and a 2 Bedroom self contained apartment for up to 8 people.'), dom('p', [
          'The wedding ceremony is ', dom('a', {
            attributes: {
          ...
          }, '42 minutes away'), ' in Hamilton so you will have to organise transport to and from the ceremony. There is no taxi service or buses available.'
        ]), dom('p', 'Other accommodation options include:'), dom('ul', [
          dom('li', dom('a', {
            attributes: {
              href: 'https://www.facebook.com/raglanpalm'
            }
          }, 'Raglan Palm Beach Motel')), dom('li', dom('a', {
            attributes: {
              href: 'http://www.raglanholidaypark.co.nz/'
            }
          }, 'Raglan Kopua Holiday Park')), dom('li', dom('a', {
            attributes: {
              href: 'http://www.hiddenvalleyraglan.com/'
            }
          }, 'Hidden Valley Luxury Retreat')), dom('li', dom('a', {
            attributes: {
              href: 'http://raglanfarmstay.com/'
            }
          }, 'Raglan Farmstay')), dom('li', dom('a', {
            attributes: {
              href: 'http://www.raglan.net.nz/2009/10/harbour-view-hotel/'
            }
          }, 'Harbour View Hotel')), dom('li', dom('a', {
            attributes: {
              href: 'http://www.oceanviewraglan.com/'
            }
          }, 'Ocean View Raglan')), dom('li', dom('a', {
            attributes: {
        ...
        dom('h2', 'Our Wedding Wish'), dom('p', {
          attributes: {
            "class": 'poem'
          }
        }, ["We've been together quite a while, with all our pots and pans.", dom('br'), "And as we don't need homely gifts we have another plan!", dom('br'), "We know it's not traditional and not the way it's done.", dom('br'), "But rather than a wedding list we'd love a bit of sun!", dom('br'), "So if you would like to give a gift and send us on our way.", dom('br'), "A donation to our honeymoon would really make our day!", dom('br'), "But the choice is really up to you, and we would like to say,", dom('br'), "that the best gift we could receive, is you, here, on our special day!"]), dom('p', 'Sponsoring part of our holiday will help us celebrate your contribution. We can think of you at that time.'), dom('p', 'Here are some ideas for sponsoring.'), dom('ol', [dom('li', 'A roadside snack'), dom('li', 'A meal together'), dom('li', 'An activity during the day'), dom('li', 'Accomodation for one night'), dom('li', 'A short flight to a neighbouring area'), dom('li', 'A flight to a distant land')]), dom('p', 'If you decide to sponsor part of our honeymoon, thank you! And please let us know so we can think of you.'), params.showbankdetails != null ? dom('div', {
          attributes: {
            "class": 'grid grid--top'
          }
        }, [dom('div', [dom('h4', 'International:'), dom('strong', 'Our details:'), dom('br'), 'T P Coats, K Harvinder', dom('br'), '3 Sandes Street,', dom('br'), 'Ohaupo 3803', dom('br'), dom('br'), dom('strong', 'Bank details:'), dom('br'), 'Citibank N.A, 23 Customs St, Auckland, New Zealand', dom('br'), dom('strong', 'SWIFT code:'), dom('span', ' CITINZ2X'), dom('br'), 'Your full name and street address is needed (not PO Box)', dom('br'), '38-9004-0745246-01']), dom('div', [dom('h4', 'Within New Zealand:'), 'T P Coats, K Harvinder', dom('br'), 'Kiwibank', dom('br'), '38-9004-0745246-01'])]) : dom('a', {
          attributes: {
            href: '#',
            "class": 'sendgift'
          },
          onclick: function(e) {
            e.preventDefault();
            return hub.emit('show bank details');
          }
        }, [gift(), dom('br'), 'Send a Gift'])
      ]), dom('hr'), dom('h2', 'RSVP'), dom('p', 'Please RSVP by 1st July 2015.'), dom('p', 'Although we really love children we would greatly appreciate if our wedding was an adult only event.'), dom('form', {
        onsubmit: submit
      }, [
